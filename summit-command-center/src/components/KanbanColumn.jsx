  ...
  return (
    <div className="flex-1 min-w-[260px] flex flex-col">
      <div className="flex items-center justify-between px-1 mb-2">
        ...
        <span className="text-xs text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-white/5 px-1.5 py-0.5 rounded-full">{tasks.length}</span>
      </div>
      <div
        ref={setNodeRef}
        className={`flex-1 space-y-2 rounded-lg p-2 min-h-[120px] transition-colors ${
          isOver ? 'bg-blue-50 dark:bg-blue-500/10' : 'bg-gray-100/60 dark:bg-white/[0.03]'
        }`}
      >
        {tasks.length === 0 && (
